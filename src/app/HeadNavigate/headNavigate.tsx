...
export default function HeadNavigate() {
  ...
  return (
    <nav className="w-full flex items-center justify-between px-8 h-16 border-b border-black/[0.06] sticky top-0 bg-white z-50">
      ...
      <div className="flex items-center gap-5">
        ...
        >
          ...
          <span
            ref={badgeRef}
            className="flex items-center justify-center min-w-[18px] h-[18px] px-1 bg-red-500 text-white text-[11px] font-medium rounded-full"
          >
            {count}
          </span>
        </Link>
